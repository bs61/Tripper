  ...
  Future<void> _showMyDialog2(context,Plan plan1) async {
    ...
    return showDialog<void>(
        ...
        builder: (BuildContext context) {
          ...
          return AlertDialog(
            title: Text('Are you sure you want to delete ${plan1.Name}?',textAlign: TextAlign.center,style: TextStyle(fontSize: 20.0,fontWeight: FontWeight.w400),),
            shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.all(Radius.circular(20.0))
            ),
            actions: <Widget>[
              ...
              TextButton(
                  child: Text('Delete'),
                  onPressed: () {
                    Provider.of<Allplans>(context,listen: false).deletePlan(plan1);
                    Navigator.of(context).pop();
