...
class Place {
  ...
  Place(this.description, this.city, this.price, this.images,this.description2,this.position);
...
class Activity {
  ...
  Activity(this.actname, this.city, this.iconUrl, this.iconColor,this.actlist);
...
class Featured {
  ...
  Featured(this.city, this.title, this.imageUrl);
  ...
  return <Acts>[
    Acts(
      ...
      ["assets/images/activities/Visiting_museums/Archaeological_Museum_of_El-Djem/image1.jpg",
        ...
        "assets/images/activities/Visiting_museums/Archaeological_Museum_of_El-Djem/image3.png",
    ...
    Acts(
      ...
      [33.7325783,10.8634309],
      "3DT",
    ),
  ];
}
// List<List<Acts>> getallacts(){
//   return [getMuseumList(),getScubaDiveList(),getScubaDiveList(),getParachuteList(),getCampingList(),getDiscoveryList(),getHikingList(),getJetSkiList()] ;
// }